...
train_strong = load_text_file('D:/pycharm_pro/gan_enhancer/second/strong_8_8000.txt')
print("train_strong: ", len(train_strong))
train_weak = load_text_file('D:/pycharm_pro/gan_enhancer/second/weak_8_8000.txt')
...
test_strong = read_test_file('D:/pycharm_pro/gan_enhancer/second/test_strong_enhancers.txt')
print("test_strong: ", len(test_strong))
test_weak = read_test_file('D:/pycharm_pro/gan_enhancer/second/test_weak_enhancers.txt')
...
#
# np.savez('D:/pycharm_pro/gan_enhancer/second/second_index/second_train_enhancers8.npz' ,
#           X_en_tra=X_en_tra, y_tra=train_label)
# np.savez('D:/pycharm_pro/gan_enhancer/second/second_index/second_test_enhancers8.npz' ,
#           X_en_tes=X_en_tes, y_tes=test_label)

X_en_tra_onehot = get_data_onehot(train_data)
X_en_tes_onehot = get_data_onehot(test_data)

np.savez('D:/pycharm_pro/gan_enhancer/second/second_index/second_train_onehot.npz' ,
          X_en_tra=X_en_tra_onehot, y_tra=train_label)
np.savez('D:/pycharm_pro/gan_enhancer/second/second_index/second_test_onehot.npz' ,
